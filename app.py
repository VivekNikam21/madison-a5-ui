...
.hero {
    ...
    border-radius: 34px;
    background:
        radial-gradient(circle at 85% 15%, rgba(56, 189, 248, 0.20), transparent 35%),
...
with nav_left:
    st.image("aligna-logo.png", width=260)

with nav_right:
    st.markdown(
        """
        <div style="display:flex; justify-content:flex-end; align-items:center; height:72px;">
...
"""
        ...
        html = html.replace("PASS:", "<span style='color:#A7F3D0;font-weight:900;'>PASS:</span>")
        html = html.replace("FLAG:", "<span style='color:#FCA5A5;font-weight:900;'>FLAG:</span>")
        html = html.replace("REVIEW:", "<span style='color:#FDE68A;font-weight:900;'>REVIEW:</span>")
        html = html.replace(">PASS<", "><span style='color:#A7F3D0;font-weight:900;'>PASS</span><")
        html = html.replace(">FLAG<", "><span style='color:#FCA5A5;font-weight:900;'>FLAG</span><")
        html = html.replace(">REVIEW<", "><span style='color:#FDE68A;font-weight:900;'>REVIEW</span><")
